						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<div class="checkbox checkbox-primary m-b-20">
									<input type="checkbox" id="chk-admin" name="chk-admin" value="1" @if ($user->admin) checked @endif />
									<label for="chk-admin"> Admin? </label>
								</div>
								<!--
								<div class="checkbox checkbox-primary m-b-20">
									<input id="chk-can-write" name="chk-can-write" type="checkbox" @if ($user->can_write) checked @endif />
									<label for="chk-can-write"> Can Write? </label>
								</div>		
								-->		
